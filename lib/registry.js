        ...
        endpoints: [
          {
            ...
            sampleResponse: {
              type: "redirect",
              url: "https://accounts.google.com/oauth/authorize?client_id=your_client_id&redirect_uri=http://localhost:3001/auth/google/callback&scope=openid%20email%20profile"
            }
          },
          {
            ...
            sampleResponse: {
              type: "redirect",
              url: "http://localhost:3000?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...&user=encoded_user_data",
              user: {
                id: "google_67890",
